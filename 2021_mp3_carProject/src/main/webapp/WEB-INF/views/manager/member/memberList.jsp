        ...
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              ...
              <h2 class="mb-2 page-title">관리자 회원관리</h2>
	          <hr class="my-4">
		        ...
		        <%-- <div class="form-group">
					...
					<p>관리자 이름 : <sec:authentication property="principal.member.member_name"/></p>
					<p>관리자 ID : <sec:authentication property="principal.username"/></p>
					<p>관리자 권한 리스트  : <sec:authentication property="principal.member.authList"/></p>
		        </div>
