   ...
   <sec:authorize access="isAuthenticated()">
        ...
        <form role="form" action="car_fixUpdate" method="post" class="col-lg-6 col-md-8 col-10 mx-auto">
          <div class="mx-auto text-center my-4">
            ...
            <h2 class="my-3">내 정비/기타 정보 목록 수정</h2>
          </div>
		  <div class="form-group">
            <label >날짜</label>
            <input type="date" class="form-control" id="repair_date" name="repair_date" value="${fixlist.repair_date}"  required>
          </div>
		  <div class="form-group">
            <label for="repair">정비명</label>
            <input type="text" class="form-control" id="repair" name="repair" value="${fixlist.repair}" required>
          </div>
		  <div class="form-group">
            <label for="repairshop">정비소</label>
            <input type="text" class="form-control" id="repairshop" name="repairshop" value=" ${fixlist.repairshop}"  required>
          </div>
		  <div class="form-group">
            <label for="amount">금액</label>            
            <input type="text" class="form-control" id="amount" name="amount" value="${fixlist.amount}"required>
          </div>
...
$(document).ready(function(){
	var result =${car_fixUpdate}; //result 값을 읽고 get타입으로 보내온
