...
<html lang="en">
  <head>
   ...
   <sec:authorize access="isAuthenticated()">
        ...
        <form role="form" action="car_fixUpdate" method="post" class="col-lg-6 col-md-8 col-10 mx-auto">
          <div class="mx-auto text-center my-4">
            ...
            <h2 class="my-3">내 정비/기타 정보 목록 및 수정</h2>
          </div>
		  <div class="form-group">
            <label >날짜</label>
            <input type="text" class="form-control" id="car_company" name="car_company" value="${car_fixlist.repair_date}" required>
          </div>
		  <div class="form-group">
            <label for="car_model">정비명</label>
            <input type="text" class="form-control" id="car_model" name="car_model" value="${car_fixlist.repair}" required>
          </div>
		  <div class="form-group">
            <label for="car_fual">정비소</label>
            <input type="text" class="form-control" id="car_fual" name="car_fual" value=" ${car_fixlist.repairshop}"  required>
          </div>
		  <div class="form-group">
            <label for="car_model_year">금액</label>
            <input type="date" class="form-control" id="car_model_year" name="car_model_year" value="${car_fixlist.amount}"  required>
          </div>
