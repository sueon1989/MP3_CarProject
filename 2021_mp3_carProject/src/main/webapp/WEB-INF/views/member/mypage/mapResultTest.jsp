...
function getTimeHTML(distance) {
    ...
    var bycicleTime = distance / 350 | 0;
    ...
    content += '    <li>';
    content += '        <span class="label">이동거리</span><span class="number">' + distance + '</span>m';
    content += '    </li>';
//     content += '    <li>';
//     content += '        <span class="label">도보</span>' + walkHour + walkMin;
//     content += '    </li>';
    content += '    <li>';
    content += '        <span class="label">소요시간</span>' + bycicleHour + bycicleMin;
    content += '    </li>';
    content += '</ul>'
